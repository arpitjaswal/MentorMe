...
router.post('/authenticate', function (req, res) {
  ...
  router.put('/activate/:token', function (req, res) {
            ...
            user.save(function (err) {
                if(err) {
                    ...
                    var email = {
                        from: 'MentorMe Registration, support@MentorMe.com',
                        to: user.email,
                        subject: 'Activation Link request - MentorMe Registration',
                        text: 'Hello '+ user.name + 'You requested for the new activation link.Please find the below activation link Activation link Thank you Arpit Jaswal',
                        html: 'Hello <strong>'+ user.name + '</strong>,<br><br>You requested for the new activation link.Please find the below activation link<br><br><a href="http://localhost:8000/activate/'+ user.temporarytoken+'">Activation link</a><br><br>Thank you<br>Arpit Jaswal<br>'
                    };
        ...
        if(!req.body.email) {
            ...
            User.findOne({email : req.body.email}).select('username email name').exec(function (err,user) {
                ...
                if(!user) {
                    ...
                    var email = {
                        from: 'MentorMe, support@MentorMe.com',
                        to: user.email,
                        subject: 'Forgot Username Request',
                        text: 'Hello '+ user.name + 'You requested for your username.You username is ' + user.username + 'Thank you Arpit Jaswal',
                        html: 'Hello <strong>'+ user.name + '</strong>,<br><br>You requested for your username.You username is <strong>'+ user.username + '</strong><br><br>Thank you<br>Arpit Jaswal<br>'
                    };
                    ...
                    user.save(function (err) {
                        if(err) {
                            ...
                            var email = {
                                ...
                                html: 'Hello <strong>'+ user.name + '</strong>,<br><br>You requested for the forgot password. Please find the below link<br><br><a href="http://localhost:8000/forgotPassword/'+ user.temporarytoken+'">Reset password</a><br><br>Thank you<br>Arpit Jaswal<br>'
                            };
                    ...
                    user.save(function (err) {
                        if(err) {
                            ...
                            var email = {
                                ...
                                text: 'Hello '+ user.name + 'You request for the reset password.Your password has been reset. Thank you Arpit Jaswal ',
                                html: 'Hello <strong>'+ user.name + '</strong>,<br><br>You requested for the reset password. Your password has been reset.<br><br>Thank you<br>Arpit Jaswal<br>'
                            };
    ...
    // router to following - By Arpit Jaswal : 11 Oct. 2018
    ...
    // router to unfollow another user - By Arpit Jaswal : 11 Oct. 2018
                    ...
                    User.findOne( { username : req.body.author }, function (err, user) {
                        ...
                        if(!user) {
                            ...
                            var email = {
                                ...
                                text: 'Hello '+ user.username + 'Thank you Arpit Jaswal ',
                                html: 'Hello <strong>'+ user.username + '</strong>,<br>You have got some edits from :<strong>' + req.decoded.username + '</strong> on your answer :<br> Question : '+ question.question +'.<br> Your Answer : ' + question.answers[req.body.index].answer + '.<br> Edits : '+ req.body.data +'<br> Thank you<br>Arpit Jaswal<br>'
                            };
    ...
    router.post('/saythanks', function (req,res) {
        ...
        if(!req.decoded.username) {
            ...
            var email = {
                ...
                subject: 'Thank you',
                text: 'Hello '+ req.body.username + 'Thank you Arpit Jaswal ',
                html: 'Hello <strong>'+ req.body.username + '</strong>,<br> '+ req.decoded.username +' wants to say a special thanks to you for your answers.<br><br>Thank you<br>Arpit Jaswal<br>'
            };
